...
<body>
 ...
 <div id="main" class="container-fluid">
  ...
  <h3 class="page-header">Incluir caminhão</h3>
  ...
  <div class="row">
	...
	<div class="form-group col-md-5">
  	  ...
  	  <div class="form-group col-md-5">
  	  	<label for="renavan">Carga maxima</label>
  	  	<input type="text" class="form-control" id="carga" placeholder="Digite a quantidade">
  	  </div>
	</div>
	<hr />
